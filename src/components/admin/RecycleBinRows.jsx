      ...
      <tr>
        ...
        <td className="py-4 px-4.5 text-[13.5px] align-top">
          <div className="flex items-center gap-2">
            <div className={`w-6.5 h-6.5 rounded-full flex items-center justify-center text-[10px] font-bold text-white shrink-0 border border-[rgba(201,168,76,0.3)] ${props.color}`}>
              <img className="rounded-full" src={props.pic}/>
            </div>
        ...
        <td className="py-4 px-4.5 text-[13.5px] align-top">
          <div className="actions-cell">
            <button className="inline-flex items-center gap-1.5 py-3.5 px-3.5 mr-2 bg-transparent border border-[rgba(45,106,79,0.3)] text-[#2d6a4f] cursor-pointer font-['DM_Sans',sans-serif] text-[11.5px] tracking-[0.04em] transition-colors duration-200 hover:bg-[rgba(45,106,79,0.08)] hover:border-[#2d6a4f]" onClick={() => props.restoreRow(props.row)}>
