      ...
      <tr>
        ...
        <td className="py-4 px-4.5 text-[13.5px] align-top">
          <div className="actions-cell">
            <button className="inline-flex items-center gap-1.5 py-1.75 px-3.5 bg-transparent border border-[rgba(139,26,26,0.3)] text-(--crimson) cursor-pointer font-['DM_Sans',sans-serif] text-[11.5px] tracking-[0.04em] transition-[background,border-color] duration-200 hover:bg-[rgba(139,26,26,0.08)] hover:border-(--crimson)]" onClick={() => props.deleteRow(props.row)}>
